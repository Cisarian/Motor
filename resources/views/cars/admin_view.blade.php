            ...
            <div class="card">
              ...
              <table>
                ...
                <tr>
                    ...
                    <td>{{$user->email}}</td>    
                    <td>{{$user->age}}</td>    
                    <td> @foreach($user->image as $image)<img src="{{ $image->url }}" alt="Image" style=" width:100px; height: 100px;"> @endforeach</td>
                    <td><a href="{{ route('user_edit', [$user->id]) }}">Edit User</a></td>                                           
                </tr>
                @endforeach
